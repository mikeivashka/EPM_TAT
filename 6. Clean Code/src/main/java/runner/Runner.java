...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport militaryAirport = new Airport(airportService.getMilitaryPlanes());
        AirportService militaryAirportService = new AirportService(militaryAirport);
        Airport passengerAirport = new Airport(airportService.getPassengerPlanes());
        AirportService passengerAirportService = new AirportService(passengerAirport);

        System.out.println("Military airport sorted by max distance: " +
                militaryAirportService
                        .sortByMaxDistance()
                        .toString()
        );
        System.out.println("Passenger airport sorted by max speed: " +
                passengerAirportService
                        .sortByMaxSpeed()
                        .toString()
        );
